...
class Test_Common_Conf(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.file_name = generate_file_name_only(self.test_config_dir,
                                                 'test_config.cfg')
    ...
    def test_conf_8_getboolean(self):
        ...
        self.assertTrue(self._Conf.getboolean('test_conf_getboolean', 'test1'),
                        'test_conf_8_getboolean is error.')
        self.assertTrue(self._Conf.getboolean('test_conf_getboolean', 'test2'),
                        'test_conf_8_getboolean is error.')
        self.assertFalse(
            self._Conf.getboolean('test_conf_getboolean', 'test3'),
            'test_conf_8_getboolean is error.')
        self.assertTrue(self._Conf.getboolean('test_conf_getboolean', 'test4'),
                        'test_conf_8_getboolean is error.')
        self.assertFalse(
            self._Conf.getboolean('test_conf_getboolean', 'test5'),
            'test_conf_8_getboolean is error.')
        self.assertFalse(
            self._Conf.getboolean('test_conf_getboolean', 'test6'),
            'test_conf_8_getboolean is error.')
            ...
            for option_element in options:
                print('\noption: %s, key: %s, value: %s' %
                      (section_element, option_element,
                       self._Conf.get(section_element, option_element)))
            # else:
            #     print('\noption: %s, key: %s, value: %s' %
